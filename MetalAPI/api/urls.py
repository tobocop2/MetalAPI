...
urlpatterns = patterns('',
    ...
    url(r'^bands/all', views.all_band_ids, name='all_band_ids'),
    ...
    url(r'^bands/musician/(?P<musician>.+)/$', views.bands_by_musician, name='bands_by_musician'),
    ...
    url(r'^lineups/(?P<band_id>.+)/$', views.lineups_by_band, name='lineups_by_band'),
)
